...
echo "#"
cd gem5
/usr/bin/scons -j${CORES} build/X86/gem5.opt --default=X86 PROTOCOL=MESI_Two_Level_Stream
#/usr/bin/scons -j${CORES} build/X86/gem5.opt --default=X86 PROTOCOL=MESI_Three_Level_Stream 
#/usr/bin/scons -j${CORES} build/X86/gem5.fast --default=X86 PROTOCOL=MESI_Three_Level_Stream 
